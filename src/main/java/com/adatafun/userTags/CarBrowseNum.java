 ...
 * /VirtualCard-v6/limousine/carTypeList
 * /VirtualCard-v6/trafficsite/listHot/limousine
 * /VirtualCard-v6/trafficsite/list/limousine
 *
 */
public class CarBrowseNum {
    public static void main(String[] args){
        ...
        try{
            ...
            Dataset filterDS = urlDS.filter("url = '/VirtualCard-v6/limousine/carTypeList' or url = '/VirtualCard-v6/trafficsite/listHot/limousine' " +
            ...
            JavaRDD<UserTags> restUserRDD = accRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
                public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                    ...
                    user.setCarBrowseNum(tuple2IntegerTuple2._2());
                    return user;
                }
            });
