 ...
 * /VirtualCard-v6/parking/index
 * /VirtualCard-v6/parking/items
 * /VirtualCard-v6/trafficsite/list/parking
 */
public class ParkingBrowseNum {
    public static void main(String[] args){
        ...
        try{
            ...
            Dataset filterDS = urlDS.filter("url = '/VirtualCard-v6/parking/index' or url = '/VirtualCard-v6/parking/items' " +
                    "or url = '/VirtualCard-v6/trafficsite/list/parking'");
            ...
            JavaRDD<UserTags> restUserRDD = accRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
                public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                    ...
                    user.setParkingBrowseNum(tuple2IntegerTuple2._2());
                    return user;
                }
            });
