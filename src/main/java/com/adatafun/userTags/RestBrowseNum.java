...
public class RestBrowseNum {
    public static void main(String[] args){
        ...
        try{
            ...
            JavaPairRDD<String, Integer> filterRDD = accRDD.filter(new Function<Tuple2<String, Integer>, Boolean>() {
            ...
            JavaRDD<UserTags> restUserRDD = filterRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
                public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                    ...
                    user.setRestBrowseNum(tuple2IntegerTuple2._2());
                    return user;
                }
            });
...
//            accRDD.saveAsTextFile("f:/AAAAAAAAAAAAAAAA");
        } catch (Exception e){
            e.printStackTrace();
        }
    }
