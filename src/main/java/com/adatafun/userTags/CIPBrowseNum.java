 ...
 * /VirtualCard-v6/orderCip/listCip
 * /VirtualCard-v6/trafficsite/list/cip
 * /VirtualCard-v5/orderCip/getCips
 * /VirtualCard-v5/orderCip/getCips
 */
public class CIPBrowseNum {
    public static void main(String[] args){
        ...
        try{
            ...
            Dataset filterDS = urlDS.filter("url = '/VirtualCard-v6/orderCip/listCip' or url = '/VirtualCard-v6/trafficsite/list/cip' " +
                    "or url = '/VirtualCard-v5/orderCip/getCips' or url = '/VirtualCard-v5/orderCip/getCips'");
            ...
            JavaRDD<UserTags> restUserRDD = accRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
                public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                    ...
                    user.setCIPBrowseNum(tuple2IntegerTuple2._2());
                    return user;
                }
            });
