    ...
    public static void main(String[] args){
        ...
        try{
            ...
            Dataset filterDS = urlDS.filter("url = '/VirtualCard-en/lounge/detail' or url = '/VirtualCard-v5/lounge/detail' " +
                    "or url = '/VirtualCard-v6/lounge/detail' or url = '/VirtualCard-v6/lounge/buttonShow'");
            ...
            JavaPairRDD<String , Integer> accRDD = filterRDD.reduceByKey(new Function2<Integer, Integer, Integer>() {
            ...
            JavaRDD<UserTags> restUserRDD = accRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
                public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                    ...
                    user.setLoungeBrowseNum(tuple2IntegerTuple2._2());
                    return user;
                }
            });
