 ...
 */
public class CarAverageOrderAmount {
    public static void main(String[] args){
        SparkSession spark = ESMysqlSpark.getSession();
        Properties prop = ESMysqlSpark.getMysqlConf3();
        try{
            String table = "tb_order_limousine";
            ...
            JavaPairRDD<String, Tuple2<Integer, Integer>> VVIPPairRDD = rowRDD.mapToPair(new PairFunction<Row, String, Tuple2<Integer,Integer>>() {
                public Tuple2<String, Tuple2<Integer, Integer>> call(Row row) throws Exception {
                    String userId = String.valueOf(row.getAs(0));
                    Integer amount = (int)row.getDouble(1);
            ...
            JavaPairRDD<String,Tuple2<Integer, Integer>> numRDD = VVIPPairRDD.reduceByKey(new Function2<Tuple2<Integer, Integer>, Tuple2<Integer, Integer>, Tuple2<Integer, Integer>>() {
            ...
            JavaRDD<UserTags> restRDD = numFilterRDD.map(new Function<Tuple2<String, Tuple2<Integer, Integer>>, UserTags>() {
                public UserTags call(Tuple2<String, Tuple2<Integer, Integer>> tuple2IntegerTuple2) throws Exception {
                    ...
                    rest.setCarAverageOrderAmount(tuple2IntegerTuple2._2()._1() / tuple2IntegerTuple2._2()._2());
                    return rest;
                }
            });
