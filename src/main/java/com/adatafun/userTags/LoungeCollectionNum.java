 ...
 */
public class LoungeCollectionNum {
    public static void main(String[] args){
        ...
        JavaPairRDD<String, Integer> collectRDD = restCollectPairRDD.mapToPair(new PairFunction<Tuple2<Tuple2<String, String>, Integer>, String, Integer>() {
        ...
        JavaRDD<UserTags> restRDD = accPairRDD.map(new Function<Tuple2<String, Integer>, UserTags>() {
            public UserTags call(Tuple2<String, Integer> tuple2IntegerTuple2) throws Exception {
                ...
                rest.setLoungeCollectionNum(tuple2IntegerTuple2._2());
                return rest;
            }
        });
