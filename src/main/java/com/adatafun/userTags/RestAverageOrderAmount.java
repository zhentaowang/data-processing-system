 ...
 */
public class RestAverageOrderAmount {
    public static void main(String[] args){
        ...
        try{
            ...
            JavaPairRDD<String, Tuple2<Double, Integer>> timePairRDD = rowRDD.mapToPair(new PairFunction<Row, String, Tuple2<Double, Integer>>() {
                public Tuple2<String, Tuple2<Double, Integer>> call(Row row) throws Exception {
                    ...
                    return new Tuple2<String, Tuple2<Double, Integer>>(str1, tpl22);
                }
            });
            JavaPairRDD<String, Tuple2<Double, Integer>> reducePairRDD = timePairRDD.coalesce(8).reduceByKey(new Function2<Tuple2<Double, Integer>, Tuple2<Double, Integer>, Tuple2<Double, Integer>>() {
            ...
            JavaPairRDD<String, Double> resultPairRDD = reducePairRDD.mapToPair(new PairFunction<Tuple2<String, Tuple2<Double, Integer>>, String, Double>() {
                public Tuple2<String, Double> call(Tuple2<String, Tuple2<Double, Integer>> tuple2Tuple2Tuple2) throws Exception {
                    String str1 = tuple2Tuple2Tuple2._1();
                    Double avgAmout = tuple2Tuple2Tuple2._2()._1() / tuple2Tuple2Tuple2._2()._2();
                    return new Tuple2<String, Double>(str1, avgAmout);
                }
            });

            JavaRDD<UserTags> restRDD = resultPairRDD.map(new Function<Tuple2<String, Double>, UserTags>() {
                public UserTags call(Tuple2<String, Double> tuple3IntegerTuple2) throws Exception {
                    UserTags userTags = new UserTags();
                    userTags.setId(tuple3IntegerTuple2._1());
                    userTags.setUserId(tuple3IntegerTuple2._1());
                    userTags.setRestAverageOrderAmountInt(tuple3IntegerTuple2._2().intValue());
                    return userTags;
                }
            });
            SQLContext context = new SQLContext(spark);
            Dataset ds = context.createDataFrame(restRDD, UserTags.class);
//            ds.toJavaRDD().saveAsTextFile("f:/AVERAGEFDFDFDFDF");
